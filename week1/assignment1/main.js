...
let exams_scores = [{ maths: 24, english: 14 }, { maths: 34, english: 45 }]
...
let student1 = { name: "samuel", age: 56, location: "kumasi" }
let myarrary = ["kofi", 578, false, { name: "sameul", age: 67 }]
let abcd = [{ maths: 34, science: 20 }, { english: 12, science: 55 }]

console.log(student1.location);
console.log(abcd[1].english);
console.log(myarrary[2]);
console.log(myarrary[3].age);
console.log(abcd[0].science);
